...
By looking and the structure of the dataset, it is ovious that 3663 students are investigated in the training dataset. It also can be observed that many of the variables contain NA values.
